...
$("#btnEditAddMMem1").click(function(){
    ...
    var html =
        "<div style='padding-top: 10px;' id='container_subEditModuleMember"+[count_elements+1]+"'>" +
            ...
            "<div class='col-sm-4 display:inline-block''>"+
                ...
                "</div>"+
            "</div>"+
            "<button id='btnDeleteEditMMem"+[count_elements+1]+"' type='button' class='btn btn-danger' onclick='btnDeleteEditModuleMember(this.id)' style='margin-top: -0.5px'>"+Button.Delete+"</button>" +
        "</div>";
