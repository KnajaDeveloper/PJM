...
privileged aspect ProjectController_Roo_Controller {
    ...
    void ProjectController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("project_createddate_date_format", "dd/MM/yyyy");
        uiModel.addAttribute("project_updateddate_date_format", "dd/MM/yyyy");
        uiModel.addAttribute("project_datestart_date_format", "dd/MM/yyyy");
        uiModel.addAttribute("project_dateend_date_format", "dd/MM/yyyy");
    }
