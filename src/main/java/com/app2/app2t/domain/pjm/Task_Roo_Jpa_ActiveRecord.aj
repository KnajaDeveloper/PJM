...
privileged aspect Task_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> Task.fieldNames4OrderClauseFilter = java.util.Arrays.asList("taskCode", "taskName", "taskCost", "typeTask", "empCode", "detail", "dateStart", "dateEnd", "fileName", "url", "progress", "program");
